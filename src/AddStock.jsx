...
const STOCK_PRICES_URL = 'http://localhost:8080/stockprices/latest/'; 
const PORTFOLIO_URL = 'http://localhost:8080/portfolio/create'; 
const PORTFOLIOS_URL = 'http://localhost:8080/portfolio/all'; 
      ...
      <div className="mt-8">
        ...
        <ul>
          {portfolios.map((portfolio) => (
            <li key={portfolio.portfolioId} className="mb-2 p-4 border rounded-md shadow-sm">
